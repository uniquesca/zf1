...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
    ...
    protected $_validTlds = [
        ...
        // Uniques: delegated TLDs absent from upstream's list entirely,
        // per IANA tlds-alpha-by-domain 2026081500.
        'amazon',
        'kids',
        'merck',
        'spa',
        ...
        // Uniques: U-label (native script) forms for delegated IDN TLDs that
        // upstream lists only in Punycode. _tld is compared verbatim against
        // this array, so a Punycode entry does not match native-script input.
        'ελ',
        'ευ',
        'бг',
        'ею',
